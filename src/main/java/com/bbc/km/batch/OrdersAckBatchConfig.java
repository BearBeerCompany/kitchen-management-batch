...
public class OrdersAckBatchConfig {
  ...
  public JdbcBatchItemWriter<OrdersAckCsv> writer(DataSource dataSource) {
    return new JdbcBatchItemWriterBuilder<OrdersAckCsv>()
        ...
        .sql(
            "INSERT INTO orders_ack (id, order_number, table_number, insert_date, insert_time, client_name, take_away, order_notes, quantity, menu_item_id, menu_item_name, menu_item_notes, category_id, ack) "
  ...
  public Job job(JobBuilderFactory jobBuilderFactory, Step step) {
    return jobBuilderFactory.get("importOrdersJob").start(step).build();
  }
}
